...
public class UserRepositoryTest {
    ...
    public void save_shouldSaveUserEntityToDatabase() {
        ...
        userEntity.setPassword(passwordEncoder.encode("Behrooz.Mohamadi"));
        userEntity.setActive(true);
        RoleEntity roleEntity = roleRepository.findByRole(USER).get();
    ...
    public void findByUserName_shouldReturnUserEntityAndMatchesByRawPassword() {
        ...
        Assertions.assertThat(optional).isPresent();
        Assertions.assertThat(passwordEncoder.matches("Behrooz.Mohamadi", optional.get().getPassword())).isTrue();
    }
}
